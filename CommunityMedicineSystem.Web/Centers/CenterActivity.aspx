...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="form-group">
            <div class="col-sm-12">
                <a class="btn btn-primary btn-lg btn-block" role="button" href="#">Patients Registration</a>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-12">
                <a class="btn btn-default btn-lg btn-block" role="button" href="#">Treatment Given</a>
            </div>
        </div>
    </form>
</body>
