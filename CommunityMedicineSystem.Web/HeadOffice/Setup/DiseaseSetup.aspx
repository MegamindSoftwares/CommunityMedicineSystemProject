        ...
        <form class="form-horizontal" runat="server" id="medicineSetupForm">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <asp:TextBoxWatermarkExtender ID="nameTextBox_TextBoxWatermarkExtender" runat="server" Enabled="True" WatermarkText="Name" TargetControlID="nameTextBox">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <asp:TextBoxWatermarkExtender ID="descriptionTextBox_TextBoxWatermarkExtender" runat="server" Enabled="True" WatermarkText="Description" TargetControlID="descriptionTextBox">
                    </asp:TextBoxWatermarkExtender>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <asp:TextBoxWatermarkExtender ID="treatementProcedureTextBox_TextBoxWatermarkExtender" runat="server" WatermarkText="Treatement Procedure" Enabled="True" TargetControlID="treatementProcedureTextBox">
                    </asp:TextBoxWatermarkExtender>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <asp:TextBoxWatermarkExtender ID="preferedDrugsTextBox_TextBoxWatermarkExtender" runat="server" Enabled="True" TargetControlID="preferedDrugsTextBox" WatermarkText="Prefered Drugs">
                    </asp:TextBoxWatermarkExtender>
                </div>
            </div>
            <div class="form-group">
